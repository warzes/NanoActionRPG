...
public:
	...
	[[nodiscard]] void* MapMemory(const GLbitfield accessFlags = GL_MAP_READ_BIT | GL_MAP_WRITE_BIT) noexcept;
	[[nodiscard]] void* MapMemory(GLintptr offset, GLsizeiptr length, const GLbitfield accessFlags = GL_MAP_READ_BIT | GL_MAP_WRITE_BIT) noexcept;
	void UnmapMemory();
